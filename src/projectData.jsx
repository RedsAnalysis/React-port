    ...
    pageSections: [
      ...
      },
      {
        ...
        text: `
          ...
          <p>Guided by Michael Burke on a project centered around data relevant to the Florida Department of Corrections (FDC), I focused on developing a data-driven solution to enhance analytical capabilities. Leveraging datasets like <code>INMATE_ACTIVE_ROOT.txt</code> and offense records, I engineered a comprehensive Power BI dashboard. This involved extensive data wrangling and analysis using Python (with Pandas and Matplotlib in Jupyter Notebooks) and SQL. The project culminated in a powerful tool for the FDC, offering dynamic exploration of inmate population trends, demographics, and offense-specific statistics to support informed decision-making.</p>
